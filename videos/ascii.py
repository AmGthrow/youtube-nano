# https://github.com/ProfOak/ascii_py/blob/master/ascii_py/ascii_py.py
import shutil
...
class Ascii:
    ...
    def save(self, out_file: str = "out.jpg", format="JPEG"):
        """Given a filename, save image to file."""

        self.to_pic.save(out_file, format=format)
        self.to_pic.close()
